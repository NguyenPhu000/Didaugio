...
- The shared refund transition now enforces that same pending+succeeded reservation ceiling for manual and gateway intents, and rechecks it at finalization while excluding the current attempt. Failed attempts are not reserved.
...
- Combined payment/refund/cancellation focused suite: 37/37 pass.
