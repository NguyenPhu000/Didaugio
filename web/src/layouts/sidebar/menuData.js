...
/**
 * SIDEBAR MENU DATA — Cấu trúc phân nhóm chuẩn
 *
  ...
  return {
    ...
    users: [
      ...
      },
      {
        ...
        items: [
          { key: "roles", title: t("nav.users.rolesList"), url: ADMIN_ROUTES.ROLES, permission: PERMISSIONS.ROLES.VIEW },
          { key: "perms", title: t("nav.users.permissions"), url: ADMIN_ROUTES.PERMISSIONS, permission: PERMISSIONS.ROLES.VIEW_DETAIL },
        ],
      },
    ],
    ...
    business: [
      ...
      },
      {
        ...
        items: [
          ...
          { key: "booking-schedule", title: t("nav.business.bookingSchedule"), url: BUSINESS_ROUTES.BOOKING_SCHEDULE, roles: [R.BUSINESS, R.STAFF], permission: PERMISSIONS.BOOKINGS.VIEW },
