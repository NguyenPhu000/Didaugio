...
export const getContentTypes = (t) => [
  ...
  { id: "trips", label: t("admin.cms.tabLabels.sampleTrips"), icon: Compass, description: t("admin.cms.sampleTripsDesc"), color: "bg-teal-600", gradient: "from-teal-600 to-emerald-700" },
