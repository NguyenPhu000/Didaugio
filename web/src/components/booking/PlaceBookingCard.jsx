...
export const PlaceBookingCard = memo(
  ({ place, totalBookings = 0, pendingBookings = 0, isSelected, onClick }) => {
    return (
      <div
        onClick={onClick}
        className={cn(
      ...
      >
        ...
        <div className="flex items-center justify-between pt-2 border-t border-slate-200/60 dark:border-border/60 text-xs font-bold text-slate-800 dark:text-slate-200">
          <span>{totalBookings} đơn đặt</span>
          {pendingBookings > 0 && (
...
PlaceBookingCard.displayName = "PlaceBookingCard";
export default PlaceBookingCard;
