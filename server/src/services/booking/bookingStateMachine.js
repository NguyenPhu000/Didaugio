...
const ALLOWED_TRANSITIONS = {
  [BOOKING_TRANSITION.REQUEST_CONFIRM]: {
    from: [BOOKING_STATUS.PENDING, BOOKING_STATUS.PAID_PENDING_CONFIRM],
  ...
  [BOOKING_TRANSITION.USER_CANCEL]: {
    from: [BOOKING_STATUS.PENDING, BOOKING_STATUS.PAID_PENDING_CONFIRM, BOOKING_STATUS.CONFIRMED],
    to: BOOKING_STATUS.CANCELLED,
  },
  [BOOKING_TRANSITION.BUSINESS_CANCEL]: {
    from: [BOOKING_STATUS.PAID_PENDING_CONFIRM, BOOKING_STATUS.CONFIRMED],
    to: BOOKING_STATUS.CANCELLED,
  },
